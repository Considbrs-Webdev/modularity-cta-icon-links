...
namespace ModularityCtaIconLinks\Helper;
 ...
 * 
 * @package ModularityCtaIconLinks\Helper
 */
class CacheBust
{
     ...
     *
     * @param string $name The original filename (e.g., 'css/modularity-cta-icon-links.css')
    ...
    private static function getManifest(): ?array
    {
        ...
        $manifestPath = MODULARITYCTAICONLINKS_PATH . 'assets/dist/manifest.json';
